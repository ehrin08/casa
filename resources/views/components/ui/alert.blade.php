...
<div {{ $attributes->merge(['class' => "mb-6 border p-4 rounded-md shadow-sm flex items-start $classes"]) }} role="alert" x-data="{ show: true }" x-show="show" x-transition.opacity>
    ...
    <div class="ml-3 w-full flex justify-between items-center">
        ...
        <button type="button" @click="show = false" class="ml-auto flex-shrink-0 -mr-1 -mt-1 p-1.5 rounded-md inline-flex hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[inherit] focus:ring-[inherit] transition-colors">
