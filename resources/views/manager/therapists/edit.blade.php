<x-manager-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Edit Therapist</h2>
            <p class="text-sm text-gray-500 mt-1">Update profile and contact details for {{ $therapist->user->name }}.</p>
        </div>
        ...
        <form action="{{ route('manager.therapists.update', $therapist) }}" method="POST" class="p-6 md:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Changing this will update their login email.</p>
                </div>
