<x-manager-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-spa-charcoal">Edit Service</h2>
            <p class="text-sm text-spa-gray opacity-80 mt-1">Update details for {{ $service->name }}.</p>
        </div>
        ...
        <form action="{{ route('manager.services.update', $service) }}" method="POST" class="p-6 md:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        <input type="number" step="0.01" min="0" max="100" name="commission_rate" id="commission_rate" class="block w-full pr-8 border-spa-wood focus:border-[#2c3e38] focus:ring-[#2c3e38] rounded-md shadow-sm" value="{{ old('commission_rate', $service->commission_rate) }}" required>
