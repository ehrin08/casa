                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-spa-cream">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-spa-gray opacity-80 uppercase tracking-wider">Customer</th>
                                ...
                                @forelse ($bookings as $booking)
                                    <tr class="hover:bg-spa-beige transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('therapist.bookings.show', $booking) }}" class="text-[#2c3e38] hover:text-[#1f2d28]">View Details</a>
                                        </td>
                                    </tr>
                                @empty
                                    <x-ui.empty-state 
                                        ...
                                        description="You don't have any bookings assigned to you yet."
                                    />
                                @endforelse
                            </tbody>
                        </table>
