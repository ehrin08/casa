...
<head>
    <meta charset="utf-8">
    <title>My Commission Report</title>
    <style>
...
<body>
    <div class="header">
        ...
        <h2 style="font-size: 18px; margin-top: 20px; color: #2c3e38;">My Commission Report</h2>
    </div>

    <div class="meta">
        <p><strong>Therapist:</strong> {{ $therapist->user->name }}</p>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="amount">Commission Earned</th>
            </tr>
        </thead>
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align: center; padding: 30px;">No commissions found for this period.</td>
                </tr>
            @endforelse
    ...
    <div class="footer">
        This is an internally generated commission report for Casa Paraiso Body and Wellness Spa.
    </div>
</body>
</html>
