        ...
        <form action="{{ route('manager.therapist-availabilities.update', $therapistAvailability) }}" method="POST" class="p-6 md:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 mt-4 pt-4 border-t border-spa-beige">
                    ...
                    <textarea id="notes" name="notes" rows="3" class="mt-1 block w-full border-spa-wood focus:border-[#2c3e38] focus:ring-[#2c3e38] rounded-md shadow-sm">{{ old('notes', $therapistAvailability->notes) }}</textarea>
