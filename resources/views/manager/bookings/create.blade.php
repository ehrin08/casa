<x-manager-layout>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Add Walk-in Booking</h2>
            <p class="text-sm text-gray-500 mt-1">Create an appointment for a customer. Time and availability are verified upon submission.</p>
        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">End time calculated automatically.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Used for confirmation email.</p>
                        </div>
