            ...
            <div class="bg-spa-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('therapist.bookings.store') }}" method="POST" class="p-6 md:p-8">
                    ...
                    <div class="space-y-5 mb-8">
                        ...
                        <p class="text-xs text-spa-gray opacity-80">Note: This booking will automatically be assigned to you. The system will check your schedule before saving.</p>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-spa-beige flex justify-end">
