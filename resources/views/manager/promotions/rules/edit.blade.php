            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $promotionRule->name) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Description</label>
                        <textarea name="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $promotionRule->description) }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="discount_value" value="{{ old('discount_value', $promotionRule->discount_value) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" step="0.01" name="minimum_total_spent" value="{{ old('minimum_total_spent', $promotionRule->minimum_total_spent) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Min Visit Count</label>
                            <input type="number" name="minimum_visit_count" value="{{ old('minimum_visit_count', $promotionRule->minimum_visit_count) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="maximum_days_since_last_visit" value="{{ old('maximum_days_since_last_visit', $promotionRule->maximum_days_since_last_visit) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Min Recency Days</label>
                            <input type="number" name="minimum_days_since_last_visit" value="{{ old('minimum_days_since_last_visit', $promotionRule->minimum_days_since_last_visit) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="border p-4 rounded-md bg-gray-50">
                        <div class="flex items-center mb-4">
                            <input type="checkbox" name="is_off_peak_only" value="1" id="is_off_peak" {{ old('is_off_peak_only', $promotionRule->is_off_peak_only) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <label for="is_off_peak" class="ml-2 block text-sm font-medium text-gray-700">Off-Peak Only?</label>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Start Time</label>
                                <input type="time" name="off_peak_start_time" value="{{ old('off_peak_start_time', $promotionRule->off_peak_start_time ? \Carbon\Carbon::parse($promotionRule->off_peak_start_time)->format('H:i') : '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">End Time</label>
                                <input type="time" name="off_peak_end_time" value="{{ old('off_peak_end_time', $promotionRule->off_peak_end_time ? \Carbon\Carbon::parse($promotionRule->off_peak_end_time)->format('H:i') : '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="usage_limit" value="{{ old('usage_limit', $promotionRule->usage_limit) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Per-Customer Limit</label>
                            <input type="number" name="per_customer_limit" value="{{ old('per_customer_limit', $promotionRule->per_customer_limit) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                </div>
            </div>
